/**
 * @header
 * @name Dice roll less than or equal to
 * @description Roll dice and succeed if the result is less than or equal to a number
 ...
 * @description The dice result must be less than or equal to this value to succeed
 * @type number
 */
const value = 0;
