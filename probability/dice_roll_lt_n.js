/**
 * @header
 * @name Dice roll less than
 * @description Roll dice and succeed if the result is less than a number
 ...
 * @description The dice result must be less than this value to succeed
 * @type number
 */
const value = 0;
