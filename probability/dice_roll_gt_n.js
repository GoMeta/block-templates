/**
 * @header
 * @name Dice roll greater than
 * @description Roll dice and succeed if the result is greater than a number
 ...
 * @description The dice result must be greater than this value to succeed
 * @type number
 */
const value = 0;
