/**
 * @header
 * @name Unlock Lockitron
 * @description Unlock a wifi-enabled Lockitron lock.
...
const url = `https://api.lockitron.com/v2/locks/${lock}?access_token=${Meta.$env.lockitronAccessToken}&state=unlock`;
