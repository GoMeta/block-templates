/**
 * @header
 * @name User property less than or equal to
 * @description Check if a user property is less than or equal to a number
 ...
 * @inspectable
 * @name Value
 * @description The value the property must be less than or equal to
 * @type number
 */
const value = '';
